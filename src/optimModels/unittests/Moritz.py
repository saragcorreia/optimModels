...
if __name__ == '__main__':
    ...
    t1 = time.time()
    ko_chassagnole("/Volumes/Data/Documents/Projects/DeCaF/Optimizations/Data/chassagnole2002.xml",
            "/Volumes/Data/Documents/Projects/DeCaF/Optimizations/ResultsEXP/optim_chassagnole2002_serine_size5_MORITZ.csv", False)
    t2 = time.time()
#    t3 = time.time()
#    #underover_chassagnole(True)
#    t4 = time.time()
    print "generations without  multiproccessing" + str(t2 - t1)
