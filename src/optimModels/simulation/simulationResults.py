...
class simulationResult:
    ...
    def __init__(self, modelId, solverStatus, steadysatefluxesDistrib=None):
...
class stoichiometricSimulationResult(simulationResult):
    def __init__(self, modelId, solverStatus, steadysatefluxesDistrib=None, methodId=None, modifications=None):
        ...
        """
        simulationResult.__init__(self, modelId, solverStatus, steadysatefluxesDistrib)
...
class kineticSimulationResult(simulationResult):
    def __init__(self, modelId, solverStatus, steadysatefluxesDistrib=None, modifications=None, factors=None, timePoint=None):
