...
def ko_chassagnole(isMultiProc=False):
    ...
    prob.set_optim_parameters(popSize=100, maxGenerations=2, popSelectedSize=50, maxCandidateSize=5,
...
def ko_jahan(isMultiProc=False):
    ...
    prob = optimProblemConfiguration(problem, decoder=decoderReactionsKnockouts(), objectiveFunc=targetFlux("vD_SUC"),
                                     solverId=odeSolver.LSODA)
